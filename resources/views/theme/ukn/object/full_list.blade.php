...
{{--                    </th>--}}
                ...
                @foreach($objects as $object)
                    <tr class="hovered">
                        ...
                        <td>{!! $object->application->owner->company_name !!}</td>
                        <td>{!! $object->object_type ? $object->object_type->name : '-' !!}</td>
                        <td>{!! $object->punkt_ustanovki !!}</td>
{{--                        <td>--}}
{{--                            <x-status applicationStatus="{{ $object->application->status->id }}"/>--}}
{{--                        </td>--}}
                        <td>
                            <div class="actions-list">
                                <a href="{{ route('ukn.applications.objects.show',['application'=>$object->application->id,'object'=>$object->id]) }}" class="actions-list-item" data-toggle="tooltip" data-placement="bottom" title="{{ __('Show') }}">

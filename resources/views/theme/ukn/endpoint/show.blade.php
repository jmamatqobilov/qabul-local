<div class="form-group row">
    ...
    <div class="col-md-6">
        {!! $endpoint->object_type ? $endpoint->object_type->name : __('No Answer') !!}
    </div>
</div>
<div class="form-group row">
...
@endif
{!! Html::link(route('ukn.applications.endpoints.index', ['application' => $endpoint->application->id]), __('back to list'), ['class'=>'btn btn-warning']) !!}

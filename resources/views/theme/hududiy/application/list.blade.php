                        ...
                        <td>
                            <div class="actions-list">
                                @if(!Gate::denies('see', $application))
                                    <a href="{{ route('hududiy.applications.show',['application'=>$application->id]) }}" class="actions-list-item text-violet" data-toggle="tooltip" data-placement="bottom" title="{{ __('Show') }}">
                                        <i data-feather="eye"></i>
                                    </a>
                                @endif
                                @if($application->status->level > 14 && !Gate::denies('message_access', $application))
                                    <a href="#" data-toggle="modal" data-target="#messages_modal_{{ $application->id }}" class="actions-list-item">
                                ...
                                @if($application->status->level > 19)
                                    <a href="{{ route('hududiy.applications.objects.index',['application'=>$application->id]) }}" class="actions-list-item text-warning" data-toggle="tooltip" data-placement="bottom" title="{{ __('Objects') }}">
                                        <i data-feather="box"></i>
                                    </a>
                                    <a href="{{ route('hududiy.applications.endpoints.index',['application'=>$application->id]) }}" class="actions-list-item text-primary" data-toggle="tooltip" data-placement="bottom" title="{{ __('Endpoints') }}">

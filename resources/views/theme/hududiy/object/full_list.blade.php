                    ...
                    <tr class="hovered">
                        ...
                        <td>
                            <div class="actions-list">
                                <a href="{{ route('hududiy.applications.objects.show',['application'=>$object->application->id,'object'=>$object->id]) }}" class="actions-list-item" data-toggle="tooltip" data-placement="bottom" title="{{ __('Show') }}">

...
class CreateRObjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('r_objects', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedbigInteger('akt_montaja')->nullable();
            $table->foreign('akt_montaja')->references('id')->on('documents');
            ...
            $table->unsignedbigInteger('opt_refl_izm')->nullable();
            $table->foreign('opt_refl_izm')->references('id')->on('documents');
            ...
            $table->unsignedbigInteger('vip_treb_oxrany')->nullable();
            $table->foreign('vip_treb_oxrany')->references('id')->on('documents');
